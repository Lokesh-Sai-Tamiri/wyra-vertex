...
_Example: \"Target fintech VPs\" with 8 fintech case studies, partner cert, 40% proven cost reduction_

### MEDIUM = Valid but Needs Development

1-2 case studies + reasonable fit + generic/qualitative proof

_Example: \"Target healthcare CTOs\" with 2 healthcare mentions, general expertise, no specific outcomes_

### LOW = Strategic Opportunity

Minimal evidence + inferred persona + speculative use case

_Example: \"Target manufacturing IoT\" with zero manufacturing case studies, adjacent capabilities only_
